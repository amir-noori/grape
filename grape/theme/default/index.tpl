...
<head>
	...
	<link rel="stylesheet" type="text/css" href=<?php echo '"' . $GLOBALS['config']['siteURL'] . 'theme/default/public/css/index.css' . '"'; ?> />
	
</head>

<body>
    <?php 
        require_once(dirname(__FILE__) . '/layout/header.tpl');
...
<script type="text/javascript" src=<?php echo '"' . $GLOBALS['config']['siteURL'] . "/theme/default/public/js/index.js" .'"'; ?>></script>
